...
{
    public partial class 出版社字典维护 : Form
    {
        public 出版社字典维护()
        {
            InitializeComponent();
        ...
        private void 出版社字典维护_Load(object sender, EventArgs e)
        {
            init();
        }
        private void init()
        {
            ...
            try
            {
                ...
                sqlcon.Open();
                string sql = "select * from 出版社字典表";
                SqlDataAdapter da = new SqlDataAdapter(sql, sqlcon);
                DataSet ds = new DataSet();
                da.Fill(ds);
                dataGridView1.DataSource = ds.Tables[0];
                dataGridView1.Columns[0].HeaderText = "出版社名";
                dataGridView1.Columns[1].HeaderText = "地址";
                dataGridView1.Columns[2].HeaderText = "出版地";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sqlcon.Open();
                cmdstr = "insert into 出版社字典表 values({0})";
                string temstr = null;

                temstr += "'" + PubName.Text + "',";
                temstr += "'" + Address.Text + "',";
                temstr += "'" + PubAddress.Text + "',";
                temstr += "'" + Tel.Text + "',";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sqlcon = new SqlConnection(sqlstr);
                sqlcon.Open();
                cmdstr = "update 出版社字典表 set {0} where {1}";
                string temstr = null;
                temstr += "Address='" + Address.Text + "',";
                temstr += "PubAddress='" + PubAddress.Text + "',";
                temstr += "Tel='" + Tel.Text + "',";
                ...
                cmdstr = string.Format(cmdstr, temstr, "PubName='" + PubName.Text + "'");
                cmd = new SqlCommand(cmdstr, sqlcon);
                judge = cmd.ExecuteNonQuery();
                if (judge != -1)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sqlcon = new SqlConnection(sqlstr);
                sqlcon.Open();
                cmdstr = "delete from 出版社字典表 where {0}";
                string temstr = null;
                if (PubName.Text != "")
                    temstr += "PubName='" + PubName.Text + "' and ";
                if (Address.Text != "")
                    temstr += "Address='" + Address.Text + "' and ";
                if (PubAddress.Text != "")
                    temstr += "PubAddress='" + PubAddress.Text + "' and ";
                if (Tel.Text != "")
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                sqlcon = new SqlConnection(connStr);
                sqlcon.Open();
                string sql = "select * from 出版社字典表 where {0}";
                string temstr = null;
                if (PubName.Text != "")
                    temstr += "PubName='" + PubName.Text + "' and ";
                if (Address.Text != "")
